...
{
    //** LIGHT **//
    light.Position = vec3(2.0, 2.0, -.0f);

    //float radius = 3.0;
    //float speed = 0.1;  

    //light.Position.x = cos(uTime * speed) * radius;
    //light.Position.y = 2.0;
    //light.Position.z = sin(uTime * speed) * radius;

    /** MATERIALS **/
    vec4 lightCoefs = vec4(0.3,0.9,0.2,64.0);
    ...
    materials[1].ReflectionCoef = 0.1;
    ...
    materials[3].ReflectionCoef = 0.1;
    ...
    materials[4].ReflectionCoef = 0.95;
